...
public class EstacionamentoTest {
    ...
    public void casoPrimeiroMotoristaSejaSeniorEleNaoDeveSair() {
        ...
        Carro segundoCarroEstacionado = null;
        ...
        // o segundo carro estacionado deve ter sido removido (motorista não é sênior)
        assertFalse(estacionamento.carroEstacionado(segundoCarroEstacionado));
    }

    @Test
    public void casoEmQueApenasUltimoMotoristaNaoEhSenior() {

        // Estacionar 9 carros (todos de motoristas sênior)
        ...
        // último motorista que estacionou NÃO é sênior
        Motorista maria = Motorista.builder().withNome("Maria")
                .withIdade(55)
                .withPontos(3)
                .withHabilitacao("1231")
                .build();
        ...
        // Chega mais um carro para estacionar: deve ocupar a única vaga que NÃO pertence a motorista sênior
        Motorista joao = Motorista.builder().withNome("João")
                .withIdade(55)
                .withPontos(3)
                .withHabilitacao("1233")
                .build();
        Carro carroColorido = Carro.builder().withCor(Cor.COLORIDO).
                withPlaca("1234")
                .withMotorista(joao)
                .build();
        estacionamento.estacionar(carroColorido);

        assertEquals(10, estacionamento.carrosEstacionados());
        assertTrue(estacionamento.carroEstacionado(carroColorido));
        assertFalse(estacionamento.carroEstacionado(carroPreto));
    }
